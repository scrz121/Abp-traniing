...
namespace FirstProject.Web.Startup
{
    ...
    /// </summary>
    public class FirstProjectNavigationProvider : NavigationProvider
    {
            ...
            context.Manager.MainMenu
                .AddItem(
                    new MenuItemDefinition(
                        PageNames.PublisherList,
                        L("PublisherList"),
                        url: "Publishers",
                        icon: "fa fa-barcode",
                        requiresAuthentication: true,
                        permissionDependency: new SimplePermissionDependency(PermissionNames.Pages_Publishers_Read)
                        )
                )
                 .AddItem(
                    new MenuItemDefinition(
                        ...
                        icon: "fa fa-book",
                        requiresAuthentication: true,
                        permissionDependency: new SimplePermissionDependency(PermissionNames.Pages_Books_Read)
                        )
                )                 
                 .AddItem(
                    new MenuItemDefinition(
