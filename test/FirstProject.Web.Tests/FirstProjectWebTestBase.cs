...
{
    public abstract class FirstProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FirstProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FirstProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FirstProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FirstProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FirstProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FirstProjectDbContext, Task<T>> func)
        {
            T result;
